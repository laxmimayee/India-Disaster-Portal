...
class AdvertisementsControllerTest < ActionController::TestCase
  ...
  test "should create advertisement" do
    assert_difference('Advertisement.count') do
      post :create, advertisement: { add_description: @advertisement.add_description, add_heading: @advertisement.add_heading, approve: @advertisement.approve, display_at: @advertisement.display_at }
    end
  ...
  test "should update advertisement" do
    patch :update, id: @advertisement, advertisement: { add_description: @advertisement.add_description, add_heading: @advertisement.add_heading, approve: @advertisement.approve, display_at: @advertisement.display_at }
    assert_redirected_to advertisement_path(assigns(:advertisement))
  end
